		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<div class="module-rules">
					...
					<p>This module is based on a element called a "card". Modifier classes are applyed to the card element to apply certain styles. In this instance the "small" class is used to adjust the heading (h2) size.</p>
